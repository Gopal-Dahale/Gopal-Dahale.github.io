                    ...
                    <MenuList zIndex={5}>
                      <NextLink href={'/tech-stack'} passHref>
                        <Link onClick={onClose}>
                          <MenuItem>
                            <HStack>
                              <Icon as={AiTwotoneThunderbolt} size={18} color={menuProps.color} />
                      ...
                      <NextLink href={'/developer-story'} passHref>
                        <Link onClick={onClose}>
                          <MenuItem>
                            <HStack>
                              <Icon as={MdTimeline} size={18} color={menuProps.color} />
                      ...
                      <NextLink href={'/achievements'} passHref>
                        <Link onClick={onClose}>
                          <MenuItem>
                            <HStack>
                              <Icon as={BsCheckCircle} size={18} color={menuProps.color} />
