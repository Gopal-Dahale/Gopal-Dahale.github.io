...
export default function Index() {
  return (
    <PageLayout
      ...
      keywords="Quantum Computing, Machine Learning, Quantum Machine Learning, Variational Methods, Quantum Noise Mitigation, Quantum Chemistry, Carbon-capture, Measurement based Imaginary Time Evolution (ITE), HEP, Google Summer of Code, Quantum Open Source Foundation, Qiskit Advocate"
